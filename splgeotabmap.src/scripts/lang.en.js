...
window.splgeotabmap.lang.en = {
  ...
  "error_startup_nosettings":           "getSplSettings() FAILED:<br />Invalid or missing SpartanLync Tools/Map Settings",
  "error_startup_nosplmap":             "getSplSettings() FAILED:<br />Missing SpartanLync Map configuration.<br />Please run Spartanlync Map first",
  "error_startup_nospltools":           "getSplSettings() FAILED:<br />Missing SpartanLync Tools configuration.<br />Please run Spartanlync Tools first",
