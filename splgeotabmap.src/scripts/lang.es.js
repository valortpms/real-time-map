...
window.splgeotabmap.lang.es = {
  ...
  "panel_user_instruction":             "Coloca el cursor sobre un veh&iacute;culo o haz clic en &eacute;l para ver la informaci&oacute;n m&aacute;s reciente del sensor SpartanLync",

  "error_title":                        "Error",
  "error_app_title":                    "Error de SplGeotabMap",
  "error_startup_general":              "getSplSettings() FALL&Oacute;:",
  "error_startup_nosettings":           "getSplSettings() FALL&Oacute;:<br />Herramientas / Configuraci&oacute;n del mapa de SpartanLync no v&aacute;lidas o faltantes",
  "error_startup_nosplmap":             "getSplSettings() FALL&Oacute;:<br />Falta la configuraci&oacute;n del mapa SpartanLync.<br />Primero ejecute Spartanlync Map",
  "error_startup_nospltools":           "getSplSettings() FALL&Oacute;:<br />Falta la configuraci&oacute;n de SpartanLync Tools.<br />Primero ejecute Spartanlync Tools",
