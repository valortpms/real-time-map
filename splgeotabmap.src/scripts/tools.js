...
const showVehTooltip = function (my, vehId, vehName) {
  console.log("Veh [ " + vehName + " / " + vehId + " ]");
  my.service.tooltip.show(
    {
      icon:
...
const showVehDetailsPanel = function (my, vehId, vehName, vehSpeed) {
  my.vehNameObj.innerHTML = vehName;
  my.vehSpeedObj.innerHTML = vehSpeed ? vehSpeed + " km/h" : "";

  if (my.sensorTblObj.classList.contains("hidden")) {
    my.sensorTblObj.classList.remove("hidden");
  }
};
